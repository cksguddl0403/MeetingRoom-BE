...
public enum InquiryErrorCode implements ErrorCode {
    ...
    INQUIRY_IMAGE_NAME_LENGTH_EXCEEDED(HttpStatus.BAD_REQUEST, "INQUIRY-09", "문의 이미지 파일명은 255자를 초과할 수 없습니다."),
    INQUIRY_IMAGE_SIGNATURE_INVALID(HttpStatus.BAD_REQUEST, "INQUIRY-10", "문의 이미지 파일 시그니처가 확장자와 일치하지 않습니다."),
