...
public enum EquipmentErrorCode implements ErrorCode {
    ...
    EQUIPMENT_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "EQUIPMENT-02", "이미 존재하는 비품입니다."),
    ROOM_EQUIPMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "EQUIPMENT-03", "회의실 비품를 찾을 수 없습니다."),
