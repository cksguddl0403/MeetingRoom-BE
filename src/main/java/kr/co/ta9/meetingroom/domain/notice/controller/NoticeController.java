...
public class NoticeController {
    ...
    // 공지사항 상세 조회
    @GetMapping("/{noticeId}")
    public ResponseEntity<ApiResponse<NoticeDto>> getNotice(@PathVariable Long noticeId) {
    ...
    public ResponseEntity<ApiResponse<OffsetPageResponseDto<NoticeListDto>>> getNotices(
        ...
        return ResponseEntity.ok(ApiResponse.success(noticeService.getNotices(pageable, noticeListSearchRequestDto)));
    }
}
